...
def test_marginal_likelihood_scenario_1(
    exercise_results_bayes_coin_game_scenario1,
):
...
def test_probability_of_winning_scenario_1(
    exercise_results_bayes_coin_game_scenario1,
):
    (
        _,
...
def test_marginal_likelihood_scenario_2(
    exercise_results_bayes_coin_game_scenario2,
):
...
def test_probability_of_winning_scenario_2(
    exercise_results_bayes_coin_game_scenario2,
):
    (
        _,
...
def test_marginal_likelihood_scenario_3(
    exercise_results_bayes_coin_game_scenario3,
):
...
def test_probability_of_winning_scenario_3(
    exercise_results_bayes_coin_game_scenario3,
):
    (
        _,
